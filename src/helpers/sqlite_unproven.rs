//! Durable storage behind the core [`Index`] trait, so SQLite never reaches a
...
use crate::core::offer::{EdgeKind, Key, Offer, Role, Scope};
use crate::core::typestate::Asserted;
use crate::helpers::crypto_unproven::fact_id;
