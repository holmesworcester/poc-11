...
| `src/facts/link/` | **link fact family**: `project` holds proven typed construction, codec, extract, and project; `api_unproven` reports observations; `cli_unproven` is the app admission/formatting adapter |
