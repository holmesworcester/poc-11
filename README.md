...
| `src/facts/link/` | **link fact family**: `project` holds typed construction, codec, extract, project, and Verus kernels for the stylized link invariants; `api_unproven` and `cli_unproven` remain adapter layers |
