...
| `src/facts/link/` | **link fact family**: `project_unproven` holds typed construction, codec, extract, project, and local Verus kernels; it stays `_unproven` until byte codec, exact report vectors, and core/replay composition are fully proved |
