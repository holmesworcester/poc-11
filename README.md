...
| `src/facts/link/` | **link fact family**: `project` holds typed construction, codec, extract, project, read-model updates, and the stylized link Verus composition proof |
